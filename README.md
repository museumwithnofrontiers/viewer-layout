...
export default {
  navigation: {
    ...
    footerLinks: [{ label: 'core.footer.aboutMwnf', href: mwnfLinks.about, external: true }],
    sectionTitles: { collection: 'core.section.collection', partners: 'core.section.partners' },
